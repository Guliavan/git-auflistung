...
describe('repository-contributor-list', () => {
    ...
    it('renders with contributor list', async () => {
        ...
        // expect(page.root).toEqualHtml(`<repository-contributor-list> <mock:shadow-root> <article> <header> <h2> Repository Contributors (2) </h2> </header> <table class=\"contributor__list\"> <tr> <th> Avatar </th> <th> Login </th> <th> Contributions </th> <th> Name </th> <th> Company </th> <th> Location </th> </tr> <tr> <td> <img alt=\"Avatar image for loginzxl\" class=\"contributor__avatar\" src=\"http://someimageurl.tld\"> </td> <td> loginzxl </td> <td> 23 </td> <td> Contributor Name </td> <td> Contributor Cie </td> <td> Contributor Location </td> </tr> <tr> <td> <img  alt=\"Avatar image for loginzxl2\" class=\"contributor__avatar\" src=\"http://someimageurl2.tld\"> </td> <td> loginzxl2 </td> <td> 1 </td> <td> Contributor Name </td> <td> Contributor Cie </td> <td> Contributor Location </td> </tr> </table> </article> </mock:shadow-root> </repository-contributor-list>`);
    });
});
